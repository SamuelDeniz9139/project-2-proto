...
const AnimeForm=(props)=>{
    return (
        ...
        method="POST" className="animeForm">
            <input className='animeField' id="animeName" type="text" name="name" placeholder="Anime Title" /><br></br>
            <input className='animeField' id="animeGenre" type="text" name="genre" placeholder="Genre" /><br></br>
            <input className='animeField' id="animeRating" type="number" min="0" name="rating" placeholder="Rating" /><br></br>
